...
const products = [
  {
    ...
    description: "AirPods Pro feature up to 2x more Active Noise Cancellation, plus Adaptive Transparency, and Personalised Spatial Audio with dynamic head tracking for immersive sound. Now with multiple ear tips (XS, S, M, L) and up to 6 hours of listening time.",
    brand: "Apple",
    catagory: "Electronic",
    price: 8999,
    discont:5,
  ...
  },
  {
    ...
    description: "You can plug the Logitech B100 wired optical mouse into the USB port of your computer or laptop, and it will be ready for use. It sports an ambidextrous design that lets both right- and left-handed users use it conveniently. Plus, its robust build ensures a reliable lifespan.",
    brand: "Logitech",
    catagory: "Electronic",
    price: 365,
    discont:0,
  ...
  },
  {
    ...
    description: "Brace yourself for a whole new world of possibilities as the PS5 unleashes unparalleled power and innovation. Get ready to elevate your gaming experience to new heights with the Sony PlayStation 5 Console. Unleash the power of play, immerse yourself in stunning visuals, and explore a world of endless possibilities. With the PS5, gaming will never be the same again.",
    brand: "SONY",
    catagory: "Electronic",
    price: 200,
    discont:10,
